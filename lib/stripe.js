...
const PLANS = {
  ...
  description: {
    ...
    label: 'Local Starter',
    prices: {
      monthly: 'price_1Th7OPK1vUxuml5k031TPUaD',
      yearly:  'price_1Th7QdK1vUxuml5kERIEE88B'
    }
  },
  starter: {
    product_limit: 125,
    ...
    label: 'Starter',
    prices: {
      monthly: 'price_1Tf0lJK1vUxuml5kfI7iAIBN',
      yearly:  'price_1Tf0mYK1vUxuml5kTJ1C5RTs'
    }
  },
  growth: {
    product_limit: 300,
    ...
    label: 'Growth',
    prices: {
      monthly: 'price_1Tf0lbK1vUxuml5k6CaHsWT9',
      yearly:  'price_1Tf0mwK1vUxuml5kIfSfRcH4'
    }
  },
  pro: {
    product_limit: 700,
    ...
    label: 'Pro',
    prices: {
      monthly: 'price_1Tf0lxK1vUxuml5k7ZtaJrPb',
      yearly:  'price_1Tf0nMK1vUxuml5ksnG1NyMj'
    }
  },
  enterprise: {
    product_limit: 1400,
    ...
    prices: {
      monthly: 'price_1Tf0lJK1vUxuml5kfI7iAIBN',
      yearly:  'price_1Tf0nlK1vUxuml5kohHIhKtr'
    }
  }
};
...
module.exports = function registerStripe(app, { supabase }) {
  ...
  app.post('/create-checkout', async (req, res) => {
    ...
    try {
      ...
      // Nese ekziston nje subscription AKTIVE -> perditesoje (upgrade/downgrade me
      // proration), mos krijo nje te re (do shkaktonte dyfishim faturimi).
      ...
      if (existingSubs.data.length > 0) {
        ...
        // S'ka checkout UI - ndryshimi aplikohet direkt te subscription ekzistuese
        return res.json({ url: `${APP_URL}/dashboard?shop=${shop}&checkout=success&plan=${plan}` });
      }
  ...
  app.get('/checkout', async (req, res) => {
    ...
    console.log('[checkout] plan:', plan, 'billing:', billing, 'shop:', shop);
        ...
        case 'customer.subscription.updated': {
          ...
          if (shop) {
            await supabase.from('stores').update({
              ...
              plan_started_at: status === 'active' && planName !== 'free' ? new Date().toISOString() : null
            }).eq('shop', shop);
